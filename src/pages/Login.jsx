        ...
        <img className='hidden sm:block absolute w-full h-full object-cover' src="https://www.xtrafondos.com/descargar.php?id=4196&resolucion=1920x1080" alt="background" />
            ...
            <div className='max-w-[450px] h-[600px] mx-auto bg-black/75 text-white'>
                <div className='max-w-[320px] mx-auto py-16 '>
                    ...
                    <h1 className='txt-3xl font-bold '> Sing In</h1>
                    ...
                    <form onSubmit={handleSubmit} className='w-full flex flex-col'>
                        ...
                        <button type="submit" className='bg-red-600 py-3 my-6 rounded font-bold uppercase'>Sing In</button>
                        <div className='flex justify-between items-center text-sm text-gray-600'>
                            <p><input className='mr-2' type="checkbox"/>Remember Me</p>
                            <p className='text-gray-500 '>Need Help?</p>
                        </div>
                        <p className='py-4'><span className='text-gray-500'>New to AppFlix?</span>{" "} <Link to="/singup">Sing Up</Link> </p>
